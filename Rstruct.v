...
From Lindemann Require Import archi.
...
Canonical R_archiNumDomainType := ArchiNumDomainType R Rarchimedean_axiom. 
Canonical R_archiNumFieldType := [archiNumFieldType of R].
Canonical R_archiRealDomainType := [archiRealDomainType of R]. 
Canonical R_archiRealFieldType := ArchiFieldType R Rarchimedean_axiom.
...
Canonical R_archiRcfType := [archiRcfType of R]. 
